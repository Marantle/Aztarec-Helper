...
local NERF = "Since a 12.1 build the game hands out no coordinates inside this delve. "
    ...
    .. "Recording is manual now. During the Sermon, press a section key or click the quarter "
    ...
    .. "Also, sorry for shouting in your ear with the new audio directions, I wanted to use "
...
local INSTR = "Azta'rec slams three quarters of the room at once during Sermon of Ula'tek "
    ...
    .. "When the echoes start, the board lights the quarter you are due in green and the "
